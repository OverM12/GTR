  ...
  return (
    <>
      <div className="w-full max-w-[1280px] mx-auto px-3 sm:px-4 lg:px-6">
        <h3 className="text-[24px] lg:text-2xl font-bold mb-4 sm:mb-6">Subscription Plan</h3>
        <div className="mb-6 sm:mb-8 flex flex-col lg:flex-row gap-3 sm:gap-4">
          <div className="bg-gray-100 p-3 sm:p-4 rounded-2xl flex flex-col lg:flex-row justify-between items-start lg:items-center w-full">
            <div className="flex flex-col p-3 sm:p-4 gap-3 flex-1 rounded-2xl bg-[#F0F1F5] w-full lg:w-auto">
              <div className="flex items-center gap-2 px-3 py-2 bg-[#ff9933] rounded-full w-fit">
                ...
                <div className="text-[#151B2A] text-[14px] font-bold">Premium Plan</div>
              </div>
              <p className="text-[14px] text-gray-600">1 assessments for free. Log in as many time as you want.</p>
            </div>
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-3 sm:gap-4 flex-1 p-3 sm:p-4 mt-3 lg:mt-0">
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-[48px] sm:text-4xl font-bold">10</span>
                  <span className="text-[14px] sm:text-base -mt-4 sm:-mt-5">USD</span>
                </div>
                <div className="text-[12px] leading-relaxed text-[#151B2A]">
                  Per month <br />
                  (120.0 USD per year)
                </div>
              </div>
              <div className='px-2 sm:px-4'>
                <button className="w-full lg:w-auto border border-gray-300 rounded-full py-2 px-4 text-sm flex items-center gap-2 hover:bg-gray-50 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="13.50" height="13.48" viewBox="0 0 18 18" fill="none">
          ...
          <div className="flex flex-col w-full lg:w-[300px] p-3 sm:p-4 items-start self-stretch bg-white rounded-2xl">
            <div className="text-[14px] text-gray-600">Next Payment Due</div>
            <div className="text-[18px] sm:text-lg font-bold mt-2">20 April, 2025</div>
          </div>
        </div>
        <div className="mb-6 sm:mb-8">
          <h3 className="text-[24px] lg:text-2xl font-bold mb-4 sm:mb-6">Billing History</h3>
          <div className="overflow-x-auto border border-[#E6E7F0] rounded-2xl">
            <div className="min-w-full overflow-hidden">
              <table className="w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <th scope="col" className="px-3 py-3 text-left text-[14px] font-bold text-gray-500 uppercase tracking-wider">Header</th>
                    <th scope="col" className="px-3 py-3 text-left text-[14px] font-bold text-gray-500 uppercase tracking-wider">Header</th>
                    <th scope="col" className="px-3 py-3 text-left text-[14px] font-bold text-gray-500 uppercase tracking-wider">Header</th>
                    <th scope="col" className="px-3 py-3 text-left text-[14px] font-bold text-gray-500 uppercase tracking-wider">Header</th>
                  </tr>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {[...Array(5)].map((_, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      <td className="px-3 py-3 whitespace-nowrap text-[14px] text-gray-500">Header</td>
                      <td className="px-3 py-3 whitespace-nowrap text-[14px] text-gray-500">Header</td>
                      <td className="px-3 py-3 whitespace-nowrap text-[14px] text-gray-500">Header</td>
                      <td className="px-3 py-3 whitespace-nowrap text-[14px] text-gray-500">Header</td>
                    </tr>
        ...
        <div className="space-y-4">
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-3 sm:gap-4">
            <h3 className="text-[24px] lg:text-2xl font-bold">Payment Method</h3>
            <div className="flex text-[12px] text-gray-500 px-3 py-2 rounded-lg bg-[#F0F1F5]">
              Manage payment by
              <div className="flex items-center gap-2 px-2">
                <Image src='/your-gtr/users_img/stripe.svg' alt='Stripe' className="w-[34px] h-[14px]" width={1920} height={1080} />
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between w-full flex-wrap md:flex-nowrap">
              <div className="flex items-center gap-3">
                <div className="text-blue-600">
                  <Image src="/your-gtr/users_img/visa.svg" alt="Payment Icon" className="w-[64px] h-[64px]" width={1920} height={1080} />
                </div>
                <div>
                  <div className="text-[14px] text-gray-500">Payment Method</div>
                  <div className="text-[18px] font-medium">•••• •••• 1234 1234</div>
                  <div className="text-[18px] text-gray-500">03/27</div>
                </div>
              </div>
              <button className="border border-gray-300 rounded-full px-3 py-1 text-[14px] flex items-center gap-2 mt-3 md:mt-0">

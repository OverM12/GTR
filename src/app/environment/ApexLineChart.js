  ...
  useEffect(() => {
    const fetchChartData = async () => {
      ...
      try {
        ...
        const historyData = response?.data?.data?.areas?.environment?.gtrHistory || [];
  ...
  return (
    <>
      <div className="md:hidden bg-white rounded-[40px] p-[16px] flex flex-col gap-[16px]">
        <div className="p-[8px]">
          <h1 className="font-bold text-[18px]">Obtainment Time Journey</h1>
          {loading ? (
        ...
        <button className="border flex gap-[8px] items-center justify-center rounded-[24px] p-4 text-[#31363F]">
          <Image
            src="/your-gtr/your-gtr/dashboard/forecast-icon.png"
            width={22}
            height={22}
        ...
        <button className="border flex gap-[8px] items-center justify-center rounded-[24px] p-4 text-[#31363F]">
          <Image
            src="/your-gtr/your-gtr/dashboard/pattern-detection-icon.png"
            width={22}
            height={22}
